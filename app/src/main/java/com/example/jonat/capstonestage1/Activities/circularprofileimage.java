...
/**
 * Created by jonat on 12/8/2016.
 */

public class circularprofileimage extends AppCompatImageView
{
    ...
    public circularprofileimage(Context context, AttributeSet attrs, int defStyle )
    {
